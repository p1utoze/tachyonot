...
class SimaticLLM:
    ...
    def _initialize_model(self):
        self.llm = Llama(model_path=self.config["model_path"], temperature=self.config['temperature'],
        ...
        self.vectorstore = FaissVectorStore(self.config["embedding_dimension"], self.config["storage_path"])
        ...
        self.embeder = LLamaCPPEmbedding(self.config["embedding_model"], chunk_size=100, chunk_overlap=20)
...
if __name__ == "__main__":
    ...
    generator = chain.invoke("What is DROPEX and how does it help in Disaster rescue and Disaster Risk Management ("
                             "DRM)?")
